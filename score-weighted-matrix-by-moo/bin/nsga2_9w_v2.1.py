...
def main(NGEN, MU, seed):
    ...
    CXPB = 0.3 # probabilidad de cruce (hiperparametro)  0.7 mas utilizado
    # MUTPB = # probabilidad de mutacion (hiperparametro)  0.3 mas utilizado
    # MU =   # numero de individuos a seleccionar para cada generacion
    # LAMBDA =  # numero de hijos a producir en cada generacion
